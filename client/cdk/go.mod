module github.com/fhke/infrastructure-abstraction/cdk
...
replace github.com/fhke/infrastructure-abstraction/util => ../util/

replace github.com/fhke/infrastructure-abstraction/sdk => ../sdk
